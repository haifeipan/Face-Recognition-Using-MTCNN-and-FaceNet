...
class GeneratePairs:
    ...
    def __init__(self, data_dir, repeat_times=10):  # 我改成10次了
        """
...
if __name__ == '__main__':
    data_dir = './facenet_dataset/bw_true_96/validation_true_96'
    save_dir = './facenet_dataset/bw_true_96/PAIRS'
    rename_and_resize(data_dir=data_dir, save_dir=save_dir) #原版
    generatePairs = GeneratePairs(data_dir=save_dir)   #原版
    # generatePairs = GeneratePairs(data_dir=data_dir)
